...
var vue = new Vue({
    ...
    created : function(){
        ...
        window.onscroll=function(){
            ...
            let heightsale = $('.sale').offset().top;
    ...
    methods:{
        ...
        getUser : function(url){
            this.$http.get(url).then((res) => {  //.then() 返回成功的数据
                this.userorgCode = res.data.data.org.orgCode.substring(0,11);
                this.userId = res.data.data.userId;
                this.obtainBrand(res.data.data.userChargeBrand);  //品牌处理
                this.getGroup(this.userorgCode);
            })
            .catch(function(res) {
                console.log(res)
            }) 
        ...
        getGroup : function(data){
            if(data == 'R0101020101'){
                this.groupName = '一部'
            }else if(data == 'R0101020102'){
                this.groupName = '二部'
            }else if(data == 'R0101020103'){
                this.groupName = '三部'
            }else{
                this.groupName = '测试'
                this.userorgCode = 'R0101020109';
            }
            var DWurl = '/dw/getDW.json';  
            this.dashboard(this.https+DWurl);            //仪表盘、统计
            this.agents();                               //待办任务模块
            this.departmentSale(this.https+DWurl);       //销售数据分析
            this.saleTrand(this.https+DWurl);            //销售趋势分析
            this.clienttrand(this.https+DWurl);          //客户数据分析
            this.custrend(this.https+DWurl);             //客户趋势分析
        ...
        */
        ...
        gourl : function(){
            ...
            this.potentialurl = '/maochao/rhmcrm/view/enterprise/potential.html?searchPotentialCus=1&relation=负责';
        ...
        dashquerychange : function(data){
            ...
            if(data == 4){
                ...
                this.dashboardSelect.dimension = '110000.110';
            }else if(data == 5){
                this.showQuery = '本年';
                this.dashboardSelect.time = this.time(data); 
                this.dashboardSelect.dimension = '110000.100';
            }
        ...
        */
        ...
        stayContactPotential : function(url){
         this.$http.post(url,{isManager:0},{emulateJSON: true}).then((res) => {  //.then() 返回成功的数据
        ...
        bringCustomer : function(data){
            if(data.length>0){
                ...
                this.bringCilent.push("''");
            }
            this.stayeurl = '../enterprise/enterprise.html?id='+this.bringCilent.join(',');
        },
        ...
        lowPriceAlarm : function(url){
            ...
            this.$http.post(url,data,{emulateJSON: true}).then((res) => {  //.then() 返回成功的数据
                ...
                this.lowprice = this.https+'/fenxiao/priceWarning.html?searchAlert=Alert';
            })
            .catch(function(res) {
        ...
        obtainBrand : function(data){
            ...
            if(brand.length>0){
                this.crmbrand = brand;
                //默认下拉框选中品牌
                this.saleSelect.brand = this.crmbrand[0].typecode;
                this.sale.brand = this.crmbrand[0].typecode;
                this.clientTime.brand = this.crmbrand[0].typecode;
                this.cusdatafx.brand = this.crmbrand[0].typecode;
                this.select.brand = this.crmbrand[0].typecode;
            } 
        },
        ...
        changeSale : function(){
            ...
            if(this.sale.brand == 'all'){
                this.sale.dimension = '110010.110';
            }else{
                this.sale.dimension = '111010.110';
            }
            var url='/dw/getDW.json';
        ...
        changeconditions : function(){
            var url = 'http://test.runhemei.com/maochao/dw/customerPortrait';
        ...
        */
        ...
        changeAnalysis : function(){
            if(this.cusdatafx.brand!='all' && this.cusdatafx.conditions == 'all'){
                this.cusdatafx.dimension = '111010.110';
            }else if(this.cusdatafx.brand=='all' && this.cusdatafx.conditions != 'all'){
                this.cusdatafx.dimension = '110110.110';
            }else if(this.cusdatafx.brand!='all' && this.cusdatafx.conditions != 'all'){
                this.cusdatafx.dimension = '111110.110';
            }else{
                this.cusdatafx.dimension = '111010.110';
            }
        ...
        */
        ...
        changeClient : function(data,data2){
            ...
            if(this.clientTime.brand!='all'){
                this.clientTime.dimension = '111010.110';
            }else{
                this.clientTime.dimension = '110010.110';
            }
            var url = '/dw/getDW.json';
